...
---
title: "Downloading Sepia apama Data using galah Package"
author: ""
date: "`r Sys.Date()`"
...
This manual provides a step-by-step guide on how to download data for the species *Sepia apama* (Giant Cuttlefish) using the `galah` package in R. The `galah` package is an interface to the Atlas of Living Australia (ALA) APIs, which allows you to query and download biodiversity data.
...
Replace `"januaryvv123@gmail.com"` with your own email address.
